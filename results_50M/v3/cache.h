...
class CACHE : public MEMORY {
  public:
    ...
    void (*l1i_prefetcher_cache_fill)(uint32_t, uint64_t, uint32_t, uint32_t, uint8_t, uint64_t, uint8_t);
    void (*l1i_prefetcher_prefetch_response)(uint32_t, uint64_t, uint32_t, uint32_t, uint8_t, uint64_t);
